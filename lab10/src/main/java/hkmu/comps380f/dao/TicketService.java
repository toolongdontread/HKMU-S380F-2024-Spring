...
import hkmu.comps380f.controller.TicketController;
...
public class TicketService {
    ...
    @Transactional
    public long createTicket(String customerName, String subject, String body, List<MultipartFile> attachments)
            throws IOException {
