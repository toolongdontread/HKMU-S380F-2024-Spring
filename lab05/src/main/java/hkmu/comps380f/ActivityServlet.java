...
public class ActivityServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res)
        ...
        this.viewSessionActivity(req, res);
    }
    ...
    private void recordSessionActivity(HttpServletRequest request) {
        ...
        CopyOnWriteArrayList<PageVisit> visits = (CopyOnWriteArrayList<PageVisit>) session.getAttribute("activity");
        if (!visits.isEmpty()) {
    ...
    protected void viewSessionActivity(HttpServletRequest req, HttpServletResponse res)
            throws ServletException, IOException {
        req.getRequestDispatcher("/WEB-INF/jsp/viewSessionActivity.jsp")
                .forward(req, res);
    }
}
