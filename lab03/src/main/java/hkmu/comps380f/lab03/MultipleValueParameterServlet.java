...
@WebServlet(name = "MultipleValueParameterServlet", urlPatterns = "/checkboxes")
public class MultipleValueParameterServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(fruits != null){
            ...
            writer.append("You did not select any fruit\r\n");
        }
        writer.append("</body>\r\n")
                .append("</html>\r\n");
    }
